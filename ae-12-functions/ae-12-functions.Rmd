...
1. Practice turning the following code snippets into functions. Think about what each function does. What would you call it? How many arguments does it need? (Don't forget to remove the `eval = FALSE` the chunk options when you're done if you plan to knit the document)
