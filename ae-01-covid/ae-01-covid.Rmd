---
title: "Cumulative cases from COVID-19"
date: "`r Sys.Date()`"
output: 
  html_document: 
    toc: yes
...
The following visualisation shows the number of cumulative cases vs. days elapsed since the 10th confirmed case in each country. The time span plotted for each country varies since some countries started seeing (and reporting) cases from COVID-19 much later than others.
...
ggplot(data = norm_data,
  ...
  labs(
    ...
    title = "Daily COVID-19 cases per 100,000 people, selected countries",
    subtitle = glue("Data as of", as_of_date_formatted, .sep = " "),
    caption = "Source: github.com/RamiKrispin/coronavirus"
  )
```
